...
from ..utils import (COMMON_LAYERS_PATTERN,
                     ...
                     ModulesToSaveWrapper, PeftType, _freeze_adapter,
                     _get_submodules, get_auto_gptq_quant_linear,
                     get_quantization_config, transpose)
...
class MELoraConfig(PeftConfig):
    ...
    lora_alpha: List[int] = field(
        default_factory=lambda: [16, 16, 16, 16], metadata={"help": "Lora alpha"}
    )
    ...
    mode: str = field(
        default="sum", metadata={"help": "Which mode to use for hierachical lora. "}
    )
...
class LoraLayer(BaseTunerLayer):
    ...
    def update_layer(
        self, adapter_name, r, lora_alpha, lora_dropout, mode, init_lora_weights
    ):
...
class Linear(nn.Linear, LoraLayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.update_layer(
            adapter_name, r, lora_alpha, lora_dropout, mode, init_lora_weights
        )
