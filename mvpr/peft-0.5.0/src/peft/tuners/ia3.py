...
from ..utils import (TRANSFORMERS_MODELS_TO_IA3_FEEDFORWARD_MODULES_MAPPING,
                     TRANSFORMERS_MODELS_TO_IA3_TARGET_MODULES_MAPPING,
                     ModulesToSaveWrapper, PeftType, _get_submodules,
                     _is_valid_match, transpose)
    ...
    def _check_target_module_exists(ia3_config, key):
        if isinstance(ia3_config.target_modules, str):
            ...
            target_module_found = any(
                _is_valid_match(key, target_key)
    ...
    def _create_and_replace(
        ...
        **optionnal_kwargs,
        ...
        if isinstance(ia3_config.feedforward_modules, str):
            ...
            is_feedforward = any(
                current_key.endswith(target_key)
