...
class TierNLGDataset(Dataset):
    def __init__(
        ...
        self.task_dataset = self.load_e2e_dataset(self.data_path)
    ...
    def load_e2e_dataset(self, ft_file):
        task_dataset = []
        ...
        if self.max_n_example is not None:
            task_dataset = task_dataset[:self.max_n_example]
    ...
    def tokenize(self, data_item, id):
        ...
        print('result["intervention_locations"]', result["intervention_locations"])
