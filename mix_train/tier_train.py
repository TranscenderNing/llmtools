...
import torch
from peft import LoraConfig, get_peft_model, MELoraConfig
...
def train(args):
    ...
    def get_mvpr_model(model):
        ...
        print(f"target modules is: {target_modules}")
    ...
    model = get_mvpr_model(model)
    print(f"mvpr model is: {model}")
